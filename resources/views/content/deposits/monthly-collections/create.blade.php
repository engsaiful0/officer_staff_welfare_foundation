...
@section('title', 'Add Monthly Deposit Collection')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Add Monthly Deposit Collection</h5>
      ...
      <div class="card-body">
        <form action="{{ route('deposits.monthly-collections.store') }}" method="POST" id="collectionForm" novalidate>
          @csrf
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select class="form-select @error('deposit_id') is-invalid @enderror" id="deposit_id" name="deposit_id" required>
                ...
                @foreach($deposits as $deposit)
                  <option value="{{ $deposit->id }}" data-monthly-amount="{{ $deposit->monthly_deposit_amount }}" {{ old('deposit_id') == $deposit->id ? 'selected' : '' }}>
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="hidden" id="month_year" name="month_year" value="{{ old('month_year') }}">
            ...
            <div class="col-12 mb-3">
              ...
              <textarea class="form-control @error('description') is-invalid @enderror" 
                        ...
                        placeholder="Additional notes about this collection...">{{ old('description') }}</textarea>
              @error('description')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
      ...
      success: function(response) {
        if (response.success) {
          ...
          if (typeof toastr !== 'undefined') {
            ...
            toastr.success(response.message || 'Monthly deposit collection saved successfully');
          } else {
            alert(response.message || 'Monthly deposit collection saved successfully');
          }
          ...
          // Show error message
          if (typeof toastr !== 'undefined') {
            toastr.error(response.message || 'Failed to save collection');
          } else {
            alert(response.message || 'Failed to save collection');
          }
      ...
      error: function(xhr, status, error) {
        ...
        if (xhr.status === 422 && responseJSON && responseJSON.errors) {
          ...
          const errorMessage = (responseJSON && responseJSON.message) 
            ...
            : 'An error occurred while saving the collection. Please try again.';
