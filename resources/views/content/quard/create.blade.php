  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Add New Quard</h5>
      ...
      <div class="card-body">
        <form action="{{ route('quards.store') }}" method="POST" id="quardForm" novalidate>
          @csrf
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <select class="select2 form-select @error('member_id') is-invalid @enderror" id="member_id" name="member_id" required>
                ...
                @foreach($members as $m)
                  <option value="{{ $m->id }}" {{ (old('member_id') == $m->id || ($member && $member->id == $m->id)) ? 'selected' : '' }}>
                    {{ $m->name }} ({{ $m->unique_id }})
                  </option>
                @endforeach
              </select>
            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" id="total_deposit_amount" name="total_deposit_amount" value="{{ old('total_deposit_amount', 0) }}" step="0.01" min="0" readonly>
              </div>
              <div class="form-text">Auto-populated from member deposits.</div>
            </div>
