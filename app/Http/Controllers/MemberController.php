...
class MemberController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'date_of_join_in_ibbl' => 'required|date',
        ...
        // member_unique_id / serial live in member_unique_ids; unique_id is auto-generated on members
        $memberPayload = collect($data)->except('member_unique_id', 'serial')->all();
    ...
    public function edit(Member $member)
    {
        ...
        $members = Member::where('id', '!=', $member->id)
            ->select('id', 'name', 'member_unique_id')
            ->get();
    ...
    public function update(Request $request, Member $member)
    {
        try {
            ...
            $validatedData = $request->validate([
                ...
                'diposit_account_number' => 'nullable|string|max:50',
                'designation_id' => 'required|exists:designations,id',
                'date_of_join_in_ibbl' => 'nullable|date',
